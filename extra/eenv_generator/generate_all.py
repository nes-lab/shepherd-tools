...
from ivsurfaces_multivariate_random_walk import get_config_for_workers as get_cfgs_random_walk
from ivtraces_onpattern_random_independent import get_config_for_workers as get_cfgs_onpattern
from ivtraces_onwindow_random_independent import get_config_for_workers as get_cfgs_onwindow
from ivtraces_static import get_config_for_workers as get_cfgs_static
...
def get_config_for_workers(
    ...
    cfgs: list[tuple[Callable, dict[str, Any]]] = [
        ...
        *get_cfgs_onpattern(path_dir),
        *get_cfgs_onwindow(path_dir),
        *get_cfgs_static(path_dir),
    ]
    return cfgs
...
if __name__ == "__main__":
    ...
    process_sp(get_cfgs_random_walk)
