...
DATASETS: dict[str, dict[str, Any]] = {
    "bonito_jogging_mixed": {
        ...
        "metadata": {
            ...
            "harvester": "shepherd v1, BQ25504-Converter with MPPT for solar & V_const for piezo",
    ...
    "bonito_stairs_solar": {
        ...
        "metadata": {
            ...
            "harvester": "shepherd v1, BQ25504-Converter with MPPT",
    ...
    "bonito_cars_piezo": {
        ...
        "metadata": {
            ...
            "harvester": "shepherd v1, BQ25504-Converter with V_const",
