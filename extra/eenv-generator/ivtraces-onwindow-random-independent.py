...
class RndPeriodicWindowGenerator(EEnvGenerator):
    ...
    def __init__(self, node_count, seed, period, duty_cycle, on_voltage, on_current):
        self.period = round(period / STEP_WIDTH)
        assert math.isclose(self.period, period / STEP_WIDTH), "Period * STEP_WIDTH is not an integer"
